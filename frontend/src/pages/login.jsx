  ...
  return (
    <div className="w-screen" >
      <div className = " fixed w-[45%] mt-[-12%] h-screen bg-no-repeat bg-cover flex items-center	justify-center flex-col" style = {{backgroundImage:"url(/Fundo.svg)"}}>
        <img className="mt-[-5%]" alt="ramoLogo" src= "/android-chrome-192x192.png" />
      ...
      <div className=" mt-[12%] ml-[60%] w-[30%]">
        <form className="flex justify-items-center flex-col h-[100%] w-[100%] " onSubmit={handleEnvio}>
          ...
          <div className= "ml-[40px] mb-[20px]">
            ...
            <input className="pt-3 w-[90%] h-[46px] border-2 border-green rounded-[9px] pb-[10px] pl-[10px] font-black"
              type="text"
              name="login"
              id="login"
          ...
          <div className="ml-[40px]">
            <button className="w-[90%] h-[100%] mt-[15px] border-2 border-2 border-black rounded-[9px] bg-green text-[#FFF] font-black" type = "submit">Entrar</button> 
            <button className=" w-[90%] h-[100%] mt-[15px] border-2 border-2 border-black rounded-[9px] bg-green text-[#FFF] font-black" onClick={() => navigate("/cadastro")}>Criar Conta</button> 
          </div>
        </form>
      </div>
    </div>
