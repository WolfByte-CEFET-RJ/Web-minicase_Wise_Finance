        ...
        <div className="painel-body">
          <header className="flex items-center justify-between fixed w-full h-[70px] box-border bg-green pl-5 pr-[60px] py-0;">
            ...
            <button className="w-10 cursor-pointer" onClick={abrirMenu}>
              <img
                className="w-10 h-35 cursor-pointer"
                src="/menuHamburguer.png"
                alt="menuHamburguer"
              />
            </button>
          </header>
          ...
          <div
            className={`w-full ${aberto ? "animate-[cascadeAnimation_0.3s_forwards]" : "hidden"}`}
          >
            <nav className="absolute flex flex-col items-center w-full h-[calc(100vh_-_70px)] box-border bg-[#3a3939] transition-[1s] mt-[70px] px-[30px] py-0;">
              <div className="flex items-center justify-center w-full box-border border-b-[#747474] border-b border-solid;">
                <img
                  ...
                  alt="logo"
                />
                <h2 className="text-[28px] text-white" id="sidebar-userName">
                  Wise Finance
                </h2>
              </div>
              ...
              <div className="flex flex-col items-center justify-center w-full box-border">
                <div className="w-full">
                  <div>
                    <button
                      className="flex items-center justify-start w-full h-[60px] bg-[#3a3939] transition-[1s] transition-[background-color] cursor-pointer border-[none]"
                      onClick={() => {
                        navigate("/home");
                        abrirMenu();
                      }}
                    >
                      ...
                      />
                      <span
                        className="text-base font-medium transition-all duration-[0.3s] ease-[ease-in-out] text-[rgb(253,253,253)] ml-[10px]"
                        id="sidebar-text"
                      >
                        Dashboard
                      </span>
