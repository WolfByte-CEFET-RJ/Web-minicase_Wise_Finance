      ...
      <div className="w-[100%] h-[100%]  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white  rounded-[96px]">
        <div className="container-modal">
          ...
          <div className="text-[30px] mt-[2%] ml-[10%] font-black text-green">
            ...
            <button className="  ml-[38.5%]  w-[180px] h-[23px] rounded-[96px] bg-[#1E7B71] text-[10px] font-black text-white border border-black "         // onClick={}
            >Adicionar</button> 
             <div className="text-[15px] mt-[2%] font-black text-green flex items-center">
              ...
              <div className="ml-[20%]"> 
                <button className=" mr-5 w-[105px] h-[20px] rounded-[96px] bg-[#EF0606] text-[10px] font-black text-white border border-black">
                  Editar
                </button>
                <button className="w-[105px] h-[20px] rounded-[96px] bg-[#1E7B71] text-[10px] font-black text-white border border-black">
                  Excluir
                </button>
              </div>
            </div>
          ...
          <div className="text-[30px] mt-[3%] ml-[0%] font-black text-green">
            ...
            <button className="  ml-[37%]  w-[180px] h-[23px] rounded-[96px] bg-[#1E7B71] text-[10px] font-black text-white border border-black "         // onClick={}
            >Adicionar</button> 
